...
const checks = [
  ...
  ['api/admin/content.ts', ['hierarchyScopeMatches','hierarchyField','nested','HIERARCHY_COLLECTIONS','tenantOwnerKey','ownerTenantId','proposeTranslation','reviewTranslationProposal','proposerUid','pending proposal for this translation key','effectiveOrganizationId','accessibleOrganizationIds','organizationInHierarchyScope','This certificate is outside your hierarchy scope.','scope: effectiveOrganizationId ? \'organization\' : \'platform\'','scope: ctx.tenantType === \'hierarchy\' ? \'hierarchy\' : \'platform\'','scope: \'organization\'']],
  ...
  ['src/pages/CurriculumManager.tsx', ['Publishing scope','System-wide','scopeOrganizationId','organizationOptions','getTranslation','curriculum.lessonTitleRequired']],
