...
const checks = [
  ...
  ['api/admin/content.ts', ['HIERARCHY_COLLECTIONS','tenantOwnerKey','ownerTenantId','proposeTranslation','reviewTranslationProposal', 'my_proposals', 'pending proposal for this translation key']],
