...
const checks = [
  ...
  , 'requestedMembership', "collectionGroup('members')"]],
  ['firestore.rules', [
    "'union_admin'",
    "'conference_admin'",
    "'district_admin'",
  ...
  ['api/admin/content.ts', ['HIERARCHY_COLLECTIONS','tenantOwnerKey','ownerTenantId','proposeTranslation','reviewTranslationProposal','proposerUid','pending proposal for this translation key']],
  ...
  ['src/pages/UserManagement.tsx', ['tenantOrganizationsLoading','listOrganizations','Organization']],
