...
const checks = [
  ...
  ['src/pages/AdminPage.tsx', ['scoped hierarchy administration navigation','organizations','userManagement','certification']],
  ['src/pages/CertificationManager.tsx', ['isSuperAdmin','certificate settings','Issue Certificate']],
