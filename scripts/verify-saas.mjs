...
const required=[
  ...
  ['api/mentorship.ts',['organizationId','sameTenant']],
...
for(const phrase of ['canonical editing ownership never transfers','Tenant boundaries must be enforced server-side and in Firestore rules','Curriculum content is human-authored']) if(!mission.includes(phrase)) errors.push(`Mission documentation lost invariant: ${phrase}`);
