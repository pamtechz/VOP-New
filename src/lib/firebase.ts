...
// Fail closed if a release points learner data to a different Firebase project.
if (firebaseConfig.projectId !== 'voiceofprophecy') {
  throw new Error('Wrong Firebase project configured for Voice of Prophecy.');
}
