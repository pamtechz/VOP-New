      ...
      <div className="vop-card vop-form-card">
        ...
        <>
          ...
          <div className="vop-form-grid">
            ...
            <div className="vop-field"><label>Tenant branding (JSON)</label><textarea value={branding} onChange={e=>setBranding(e.target.value)} rows={4} placeholder='{"logoUrl":"","primaryColor":"","accentColor":"","appName":""}'/><small>Branding belongs to this organization and is resolved from tenant configuration.</small></div>
