    ...
    <div className="vop-reference-manager">
      ...
      {tab === 'quizzes' ? (
        ...
        <>
          ...
          <div className="vop-reference-table-wrap">
            {loading ? <div className="vop-empty">Loading lessons from Firestore…</div> : lessonPageRows.length === 0 ? <div className="vop-empty">No lessons are configured.</div> : (
