...
export const AdminPage: React.FC<AdminPageProps> = ({ currentUser, onBack }) => {
  ...
  return <div className="vop-admin">
    <header className="vop-admin-top">
      ...
      <div className="vop-top-title"><button className="vop-menu-btn" type="button" onClick={()=>setSidebarOpen(!sidebarOpen)} aria-label="Open navigation"><Menu size={30}/></button><div><div className="vop-top-kicker">Certification</div><div className="vop-top-page">{currentPageLabel}</div></div></div>
